...
/* ======================================================================
   KAGGLE CODE PROJECTS (static, with summaries + inline thumbnails)
====================================================================== */
...
type KaggleProject = {
  ...
  comments?: number;
  scoreHint?: string;
  blurb: string; // 2-sentence summary
...
const makeThumb = (seed: number, label: string) => {
  ...
  const esc = (s: string) =>
    s.replace(/&/g, "&amp;").replace(/</g, "&lt;").slice(0, 42);
  const svg = `
...
const kaggleProjects: KaggleProject[] = [
  {
    ...
    medal: "bronze",
    blurb:
      "Deep-dived chest X-ray data with visual profiling, class imbalance checks, and leakage scans to establish a clean training base. This EDA guided my preprocessing and augmentation choices for downstream CNN and ensemble models.",
  ...
  },
  {
    ...
    votes: 53,
    medal: "bronze",
    scoreHint: "Score: 0.61",
    blurb:
      "Built an ensemble pipeline for 3D CT aneurysm detection combining model diversity with robust validation. I learned how calibrated blending and fold stability improve sensitivity without overfitting.",
  ...
  },
  {
    ...
    votes: 48,
    medal: "silver",
    scoreHint: "Score: 1.22",
    blurb:
      "Implemented a digitization pipeline using CNN-based tracing with post-processing (Gaussian smoothing, peak correction) to clean ECG waveforms. This improved signal fidelity and taught me how image artefacts impact downstream feature extraction.",
  ...
  },
  {
    ...
    medal: "bronze",
    blurb:
      "Prototyped an LLM chatbot with prompt engineering, memory, and guardrails to handle multi-turn queries. I learned to balance creativity with reliable grounding for safer, more useful responses.",
  ...
  },
  {
    ...
    medal: "bronze",
    blurb:
      "Built a lightweight CNN baseline with normalized pipelines and early stopping for fast X-ray iteration. The model set a reproducible floor that helped me measure true gains from advanced tricks.",
  ...
  },
  {
    ...
    medal: "bronze",
    blurb:
      "Explored TensorFlow training loops, data augmentation, and learning-rate schedules on a clean image benchmark. This grounded my understanding of convergence behavior and validation drift.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Experimented with LoRA fine-tuning for math reasoning, focusing on tokenization choices and targeted curricula. I learned how prompt formats and short context help smaller models reason better.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Profiled Division B dataset quality, artifacts, and label distribution to design a fair beginner-friendly track. The analysis informed simplified baselines that emphasized learning over leaderboard chasing.",
  ...
  },
  {
    ...
    medal: "bronze",
    blurb:
      "Explored mouse behavior signals and engineered interpretable features to support sequence models. I learned how temporal context and domain hints shape better feature sets.",
  ...
  },
  {
    ...
    medal: "bronze",
    blurb:
      "Mapped typical ECG image issues—skew, noise, contrast—and tested pre-processing to stabilize digitization. This EDA sped up iteration and reduced failure cases in the tracing stage.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Benchmarked EfficientNetB0 with carefully tuned augmentation and regularization on a compact dataset. The exercise reinforced that strong baselines plus tight CV can outperform heavier models.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Trained a ResNet-50 with harmonized transforms and mixed precision to push accuracy near 0.90. I learned how consistent preprocessing and LR schedules improve stability.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Created a minimal CNN starter with clean dataloaders and reproducible seeds for Division B. This helped newcomers focus on validation hygiene and principled iteration.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Implemented a hybrid recommendation approach blending content features and interaction signals. I learned how evaluation splits can dramatically affect perceived lift.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Experimented with YOLO-style detection on traffic sign datasets, tuning anchors and NMS thresholds. The project taught me to trade off recall vs. precision for different deployment needs.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Documented the step-by-step path to a strong accuracy milestone through ablations and error analysis. It reinforced the value of controlled experiments and disciplined logging.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Built a text classification pipeline with tokenization, TF-IDF/BERT features, and calibrated classifiers. I learned about leakage traps in text processing and importance of robust baselines.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Summarized week 2 leaderboard dynamics and shared learnings on augmentation and CV alignment. Writing these reports improved my ability to translate experiments into actionable steps.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Analyzed viewing trends, seasonal patterns, and content mix with tidy data workflows. I learned to design visuals that reveal timing effects without overfitting narrative.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Engineered financial features and benchmarked tree models for default risk classification. The project sharpened my understanding of class imbalance and threshold selection.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Explored protein function labels, sequence properties, and train/test overlap for CAFA6. I learned how biological context improves feature thinking for multi-label tasks.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Tracked mid-competition progress and highlighted what worked vs. what didn’t for Division B. Regular reporting kept me honest about CV stability and reproducibility.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Reflected on the first half of Division A, cataloging failed ideas and promising leads. This milestone post helped me prioritize approaches with the best ROI.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Shared Division B leaderboard shifts and baseline improvements in a digestible recap. Writing in public strengthened my communication and community feedback loops.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Analyzed a spike in submissions and how it impacted leaderboard variance. I learned to separate hype cycles from true modeling gains.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Explored audio features, popularity distributions, and genre clusters with tidy pipelines. It taught me to pair clustering with human-interpretable plots.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Processed multilingual reviews with fastText/BERT features and sentiment heuristics. I learned to standardize text pipelines across scripts and encodings.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Wrapped up Division B with final metrics, error breakdowns, and takeaways for beginners. Documenting the full journey helped others reproduce and iterate faster.",
  ...
  },
  {
    ...
    medal: null,
    blurb:
      "Summarized Division A strategy, model evolution, and leaderboard performance with actionable tips. Closing the loop taught me how to communicate tradeoffs clearly.",
...
/* ======================================================================
   GITHUB PROJECTS (live fetch all repos from GuntasDhanjal)
====================================================================== */
...
const GitHubProjectsGrid = () => {
      ...
      try {
        ...
        while (true) {
          const res = await fetch(
            `https://api.github.com/users/GuntasDhanjal/repos?per_page=${per}&page=${page}&sort=updated`
          );
  ...
  const sorted = useMemo(() => {
    // Deprioritize forks/archived; then sort by stars desc, then updated desc
    return [...repos]
      .filter((r) => !r.archived)
      .sort((a, b) => {
        const forkBias = Number(a.fork) - Number(b.fork);
        if (forkBias !== 0) return forkBias; // non-forks first
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 md:px-6 mt-12">
      <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-4">GitHub Projects</h2>
      {loading ? (
        <div className="text-sm text-muted-foreground">Loading repositories…</div>
      ) : sorted.length === 0 ? (
        <div className="text-sm text-muted-foreground">No public repositories found.</div>
      ) : (
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {sorted.map((r) => (
            <a
            ...
            >
              <div className="p-4 pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-base font-semibold leading-snug">{r.name}</h3>
                </div>
                {r.description && (
                ...
                <div className="flex items-center gap-3 text-sm text-gray-600 mt-3">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <GitFork className="w-4 h-4" /> {r.forks_count}
                  </span>
                  {r.language && (
...
/* ======================================================================
   PAGE EXPORT (Kaggle above GitHub)
====================================================================== */
